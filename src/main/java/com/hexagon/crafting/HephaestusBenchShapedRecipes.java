...
public class HephaestusBenchShapedRecipes implements IRecipe
{
    ...
    public HephaestusBenchShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public HephaestusBenchShapedRecipes func_92100_c()
    {
