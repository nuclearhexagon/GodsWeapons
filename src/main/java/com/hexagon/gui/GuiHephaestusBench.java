...
public class GuiHephaestusBench extends GuiContainer {

	private ResourceLocation texture = new ResourceLocation(Constants.MOD_ID + ":" + "textures/gui/gui_hephaestus_bench.png");
	
	public GuiHephaestusBench(InventoryPlayer invPlayer, World world, int x, int y, int z) {
		super(new ContainerHephaestusBench(invPlayer, world, x, y, z));
		this.xSize = 176;
		this.ySize = 188;
	}
